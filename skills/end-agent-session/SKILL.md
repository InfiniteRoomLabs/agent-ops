...
- If an agent is active, note the **agent name** and **division** from the output and proceed.

## Phase 2: Teardown

### Step 1: Record Agent Identity

Before deleting state, capture the agent name and division from the Phase 1 result. You need these for the teardown announcement.
