...
1. Ask which division it belongs in: core, engineering, design, marketing, sales, paid-media, product, project-management, testing, support, research, spatial-computing, game-development, specialized
...
Create `agents/{division}/{name}.md`:
