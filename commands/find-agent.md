---
name: find-agent
description: Use when searching for agents, skills, or commands by tag or keyword across all divisions
...
2. If no registry or the search term is not found there, scan all directories:
   - `agents/*/*.md`
   - `skills/*/SKILL.md`
   - `commands/*.md`
