...
IRL uses Loki for log aggregation, queried through Grafana at `http://100.86.213.22:30001`.
...
- Prometheus at `http://100.86.213.22:30090` for metrics and PromQL queries.
- Check firing alerts: `curl -s http://100.86.213.22:30093/api/v2/alerts | jq '.[] | {alertname: .labels.alertname, state: .status.state}'`
...
- Queried via Grafana at `http://100.86.213.22:30001` (datasource: Loki).
