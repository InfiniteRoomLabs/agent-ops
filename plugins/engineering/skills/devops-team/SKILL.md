...
| Repo | Path | Purpose |
|------|------|---------|
| infra | `/home/<user>/projects/infinite-room-labs/infinite-room-labs-infra/` | Terraform modules, Terragrunt configs |
| telework | `/home/<user>/projects/infinite-room-labs/telework-activity-report-builder/` | First app for deployment |
| agent-ops | `/home/<user>/projects/infinite-room-labs/agent-ops/` | This plugin's home repo |
| ideas | `/home/<user>/projects/infinite-room-labs/ideas/` | Strategic roadmap and idea tracking |
